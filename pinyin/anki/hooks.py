...
class FocusHook(Hook):
    ...
    def onFocusLost(self, fact, field):
        ...
        self.updatefact(fact, field.name, fieldchanged and pinyin.factproxy.unmarkgeneratedfield(field.value) or field.value)
...
class MassFillHook(ToolMenuHook):
    def triggered(self):
        ...
        for fact in utils.suitableFacts(self.config.modelTag, self.mw.deck):
            ...
            self.buildupdater(field).updatefact(factproxy, factproxy[field], **self.__class__.updatefactkwargs)
